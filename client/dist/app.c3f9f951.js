...
// Development
var baseURL = "http://localhost:3000/api"; // Production
  ...
  methods: {
    ...
    showAllCategories: function showAllCategories() {
      ...
      (0, _axios.default)({
        ...
        _this6.categories = _toConsumableArray(categories);
      }).catch(function (err) {
    ...
    showAllTasks: function showAllTasks() {
      ...
      (0, _axios.default)({
        ...
        if (!tasks) {
          ...
          _this7.tasks = _toConsumableArray(tasks);
        }
      }).catch(function (err) {
        var errMessage = err.response.data.message;
        console.log(errMessage);
            ...
            return _c(
              ...
              [
                ...
                _c(
                  ...
                  _vm._l(_vm.filterTasks(_vm.tasks, category.id), function(
                    task
                  ) {
                    return _c(
                      "div",
                      {
                        key: task.id,
                        staticClass:
                          "kanban-category-item shadow bg-white rounded"
                      },
                      [
                        _c("div", [
  ...
  return _c(
    ...
    [
      ...
      _vm.isLogin
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("KanbanContainer", { attrs: { isLoggedIn: _vm.isLoggedIn } })
    ],
    1
  )
}
...
// Development
var socket = (0, _socket.default)("http://localhost:3000"); // Production
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","../components/App.vue":"components/App.vue","socket.io-client":"node_modules/socket.io-client/lib/index.js","vue-socket.io-extended":"node_modules/vue-socket.io-extended/dist/vue-socket.io-ext.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
